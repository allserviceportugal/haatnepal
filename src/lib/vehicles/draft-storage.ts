...
export function saveDraftToLocalStorage(draft: Partial<DraftListing>): void {
  const stored: StoredDraft = {
    ...
    unit_of_sale: draft.unit_of_sale || null,
    min_order_quantity: draft.min_order_quantity || null,
    farm_location: draft.farm_location || null,
    for_rent: draft.for_rent || false,
    rental_rate_period: draft.rental_rate_period || null,
